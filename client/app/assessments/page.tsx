...
export default function TrainerPage() {
  const trainer = {
    name: "Dr. Ananya Sen",
    role: "Senior Trainer · Ocean Data Analytics",
    expertise: [
      "Python",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <section className="mx-auto max-w-7xl px-8 py-10">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          {/* PROFILE CARD */}
          <div className="rounded-2xl border bg-white p-7 shadow-sm lg:col-span-1">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          ...
          <ActionCard
            ...
            description="Return to the trainee learning dashboard."
            href="/"
          />
